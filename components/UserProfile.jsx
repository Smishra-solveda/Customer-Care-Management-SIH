...
const UserProfile = () => {
  ...
  return (
    <div className="text-black flex gap-2 cursor-pointer font-medium p-2">
...
<AnimatePresence>
        {isDropdownOpen && (
          ...
          exit={{ opacity: 0, y: -10 }}
          transition={{ duration: 0.2 }} className="absolute flex justify-center mt-1">


            <div className="absolute md:right-0 ml-56 md:ml-0 z-20 w-56 py-2 mt-2 origin-top-right bg-gray-100 rounded-md shadow-xl">
              <a
                href="#"
                className="flex items-center p-3 -mt-2 text-sm text-gray-600 transition-colors duration-300 transform  hover:bg-gray-400"
              >
                {/* <img
                  ...
                  alt="avatar"
                /> */}
                <div className="mx-1 text-gray-700 hover:text-gray-100">
              ...
              <a
                href="#"
                className="flex items-center p-3 text-sm text-gray-600 capitalize transition-colors duration-300 transform  hover:bg-gray-400 hover:text-gray-100 "
              >
                <svg
              ...
              >
                ...
                <span className="mx-1">Administration Connect</span>
              </a>
              ...
              <button
                className="flex items-center w-full p-3 text-sm text-gray-600 capitalize transition-colors duration-300 transform  hover:bg-red-400 hover:text-gray-100 "
